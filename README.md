...
- **ik_with_photoinhibition**: PAR where the transition point from light limitation to light saturation is achieved taking photoinhibition into account, calculated as $$ $$ $$ {ik\_with\_photoinhibition} = \frac{etrmax\_with\_photoinhibition}{alpha} $$
