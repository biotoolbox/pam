...
Those functions read raw data CSV files, compute the $$ETR$$ values, and are returning an intermediate table.
...
Device: [DUAL-PAM-100](https://www.walz.com/products/dual-pam-100/)

Mode: Dual channel mode (P700 + Fluo)
...
- Returning a table containing:
  ...
  - `yield_2`: `NA` (not available in single channel mode (P700)).  
  - `etr_1`: Calculated ETR for Photosystem I.  
  - `etr_2`: `NA` (not available in single channel mode (P700)).  
...
Device: [JUNIOR-PAM](https://www.walz.com/products/junior-pam/) 
...
Device: [PAM-2500](https://www.walz.com/products/pam-2500/)
