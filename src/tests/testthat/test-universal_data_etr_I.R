test_that("test-universal_data_etr_I - linux", {
  ...
  expect_equal(walsby[["b"]], 0.387249938)
  expect_equal(walsby[["c"]], -0.035964264)
  expect_equal(walsby[["d"]], NA_real_)
  expect_equal(walsby[["alpha"]], 0.387249938)
  expect_equal(walsby[["beta"]], -0.035964264)
  expect_equal(walsby[["etrmax_with_photoinhibition"]], 151.8614464)
  expect_equal(walsby[["etrmax_without_photoinhibition"]], 221.237842)
  expect_equal(walsby[["ik_with_photoinhibition"]], 392.1535712)
  expect_equal(walsby[["ik_without_photoinhibition"]], 571.305041)
  ...
  #expect_equal(vollenweider[["b"]], 0.001864806)
  #expect_equal(vollenweider[["c"]], -0.246826e-05)
  expect_equal(vollenweider[["d"]], 70.3820335)
  expect_equal(vollenweider[["alpha"]], 0.308564116)
  expect_equal(vollenweider[["beta"]], NA_real_)
  expect_equal(vollenweider[["etrmax_with_photoinhibition"]], 153.098976)
  expect_equal(vollenweider[["etrmax_without_photoinhibition"]], 165.4671070)
  expect_equal(vollenweider[["ik_with_photoinhibition"]], 496.165847)
  expect_equal(vollenweider[["ik_without_photoinhibition"]], 536.2487)
