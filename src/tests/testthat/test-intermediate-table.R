test_that("test-intermediate-table", {
    ...
    expect_no_error({
        ...
        ggplot2::ggsave("results/test-intermediate-table.jpg", create.dir = TRUE, plot = plot, units = "px", width = 1000, height = 1600, dpi = 100, limitsize = FALSE)
    })
})
