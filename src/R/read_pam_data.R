...
#' Read and Process DualPAM Data Single Chanel Mode Photosystem I
#'
  ...
  tryCatch(
    {
      ...
      validate_dual_pam_single_channel_I_data(data)
      data <- data[data$ID == "SP", ]
...
#' Read and Process DualPAM Data Single Chanel Mode Photosystem II
#'
  ...
  tryCatch(
    {
      ...
      validate_dual_pam_single_channel_II_data(data)
      data <- data[data$ID == "SP", ]
