#' Read and Process Diving PAM Data
#'
#' Reads raw CSV files generated by Diving PAM software, calculates electron transport rate (ETR) values, and returns a cleaned dataset.
#'
...
#' @examples
#' path <- file.path(
#'   system.file("extdata/diving_pam_data", package = "pam"),
#'   "2026_07_06_diving_pam.csv"
#' )
#' data <- read_diving_pam_data(path)
#' @export
read_diving_pam_data <- function(
  csv_path,
...
validate_diving_pam_data <- function(data) {
